...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-message-delete" '("slack-" "_slack-message-delete")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-thread" '("slack-" "all-threads-url" "lui-prompt-string")))
