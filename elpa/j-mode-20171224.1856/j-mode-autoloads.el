...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "j-console" '("j-console-" "inferior-j-mode")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "j-help" '("j-help-" "group-by" "if-let")))
