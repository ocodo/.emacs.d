...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "circe-color-nicks" '("add-circe-color-nicks" "circe-" "disable-circe-color-nicks" "remove-circe-color-nicks")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "circe-display-images" '("add-circe-display-images" "circe-display-images" "disable-circe-display-images" "remove-circe-display-images")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lui-irc-colors" '("disable-lui-irc-colors" "lui-irc-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lui-logging" '("disable-lui-logging" "enable-lui-logging" "lui-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "make-tls-process" '("make-tls-process" "tls-")))
