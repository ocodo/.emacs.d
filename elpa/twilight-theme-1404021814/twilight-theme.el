...
(custom-theme-set-faces
 ...
 ;; Temporary defaults
 '(linum                               ((t (:foreground "#454545"  :background "#2e2e2e" ))))
 ...
 '(mode-line-inactive                  ((t (:foreground "#c6c6c6"  :background "#2e2e2e" :box nil :weight light :inherit (mode-line)   ))))
 '(mode-line                           ((t (:foreground "#f8f8f8"  :background "#2e2e2e" :box nil ))))
...
;; Rainbow delimiters
 ...
 '(rainbow-delimiters-depth-2-face ((t (:foreground "#785731"))))
 '(rainbow-delimiters-depth-3-face ((t (:foreground "#835f35"))))
 '(rainbow-delimiters-depth-4-face ((t (:foreground "#8e673a"))))
 '(rainbow-delimiters-depth-5-face ((t (:foreground "#996f3e"))))
 '(rainbow-delimiters-depth-6-face ((t (:foreground "#a47743"))))
 '(rainbow-delimiters-depth-7-face ((t (:foreground "#af7e47"))))
 '(rainbow-delimiters-depth-8-face ((t (:foreground "#b7864e"))))
 '(rainbow-delimiters-depth-9-face ((t (:foreground "#bb8e59"))))
