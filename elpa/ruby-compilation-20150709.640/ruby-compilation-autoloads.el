...

;;;### (autoloads nil "ruby-compilation" "ruby-compilation.el" (0
;;;;;;  0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ruby-compilation" '("ruby-c" "pcmpl-")))
