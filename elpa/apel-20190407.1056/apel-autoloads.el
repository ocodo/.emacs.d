...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "emu" '("char-list-to-string" "insert-binary-file-contents" "running-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mcs-20" '("default-mime-charset" "mime-charset-" "widget-mime-charset-" "write-region-as-mime-charset")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mcs-e20" '("charsets-mime-charset-alist" "coding-system-" "decode-mime-charset-" "encode-mime-charset-" "mime-charset-list")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "poe" '("add-to-list" "assoc-default" "buffer-" "butlast" "character-to-event" "combine-after-change-calls" "current-" "define-obsolete-function-alias" "eval-next-after-load" "event-to-character" "functionp" "get-buffer-window-list" "last" "line-" "match-string" "min" "nbutlast" "next-command-event" "path-separator" "push" "rassoc" "rem" "save-" "split-string" "temporary-file-directory" "unless" "when" "with-")))
