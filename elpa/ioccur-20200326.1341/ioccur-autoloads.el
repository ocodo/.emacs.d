...
`ioccur-buffer' is erased and a new search is started." t nil)

(autoload 'ioccur-quit "ioccur" "\
Quit `ioccur-buffer'." t nil)

(autoload 'ioccur-next-line "ioccur" "\
Goto next line if it is not an empty line." t nil)

(autoload 'ioccur-precedent-line "ioccur" "\
Goto precedent line if it is not an empty line." t nil)

(autoload 'ioccur-beginning-of-buffer "ioccur" "\
Goto beginning of `ioccur-buffer'." t nil)

(autoload 'ioccur-end-of-buffer "ioccur" "\
Go to end of `ioccur-buffer'." t nil)

(autoload 'ioccur-jump-and-quit "ioccur" "\
Jump to line in other buffer and quit search buffer." t nil)
...
Scroll other window down." t nil)

(autoload 'ioccur-scroll-other-window-up "ioccur" "\
Scroll other window up." t nil)

(autoload 'ioccur-scroll-down "ioccur" "\
Scroll down `ioccur-buffer' and `ioccur-current-buffer' simultaneously." t nil)

(autoload 'ioccur-scroll-up "ioccur" "\
Scroll up `ioccur-buffer' and `ioccur-current-buffer' simultaneously." t nil)

(autoload 'ioccur-split-window "ioccur" "\
Toggle split window, vertically or horizontally." t nil)
