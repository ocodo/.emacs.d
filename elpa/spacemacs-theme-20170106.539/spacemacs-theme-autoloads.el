...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "spacemacs-common" '("custom-colors-override" "create-spacemacs-theme" "true-color-p" "spacemacs-theme-" "dyn-let")))
