...
This will fontify with colors the string like \"#aabbcc\" or \"blue\"."
  ...
  (progn
    (if rainbow-mode
        (rainbow-turn-on)
      (rainbow-turn-off))
    ;; re-instated font-lock-mode
    (font-lock-mode 1)
    ;; added mode-hook
    (run-hooks 'rainbow-mode-hook)
    ))

;;;; ChangeLog:

;; 2013-03-17  Jason Milkins  <jasonm23@gmail.com>
;;
;;  rainbow-mode: version 0.8
;;
;; * rainbow-mode.el: re-activated font-lock mode
;;                  : added rainbow-mode-hook  
;; 
