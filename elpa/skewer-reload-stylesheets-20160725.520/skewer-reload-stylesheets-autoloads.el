...
;;;***

;;;### (autoloads nil "skewer-reload-stylesheets-test" "skewer-reload-stylesheets-test.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from skewer-reload-stylesheets-test.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "skewer-reload-stylesheets-test" '("skewer-reload-stylesheets-test-")))
