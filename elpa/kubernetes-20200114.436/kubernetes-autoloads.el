...
Unmark everything in the buffer." t nil)

(autoload 'kubernetes-execute-marks "kubernetes-commands" "\
Action all marked items in the buffer." t nil)
...
Move backward and inspect the line at point." t nil)

(autoload 'kubernetes-logs-forward-line "kubernetes-logs" "\
Move forward and inspect the line at point." t nil)
...
Display an overview buffer for Kubernetes." t nil)
