...
(deftheme ciapre
  "ciapre-theme - Created by tmtheme-to-deftheme - 2014-06-27 18:52:57 +0800")
...
(custom-theme-set-faces
 ...
 '(mode-line-inactive                  ((t (:foreground "#aa9b64"  :background "#1b1b1b" :box nil :weight light :inherit (mode-line)   ))))
 '(mode-line                           ((t (:foreground "#c2b790"  :background "#141414" :box nil ))))
...
;; Rainbow delimiters
(defun ciapre-rainbow-delim-set-face ()
...
(eval-after-load "rainbow-delimiters" '(ciapre-rainbow-delim-set-face))
