...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode" '("elnode" "with-" "if-elnode-auth" "should-" "http-referrer" "ELNODE-FORM-DATA-TYPE")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode-rle" '("with-elnode-rle-wait" "elnode-")))
