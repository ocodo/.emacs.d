...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "circe-display-images" '("add-circe-display-images" "circe-" "disable-circe-display-images" "remove-circe-display-images")))
