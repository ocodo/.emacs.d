...
Format the contents of the current buffer without persisting the result." t nil)

(autoload 'crystal-tool-expand "crystal-mode" "\
Expand macro at point." t nil)

(autoload 'crystal-tool-imp "crystal-mode" "\
Show implementations at point." t nil)

(autoload 'crystal-tool-context "crystal-mode" "\
Show content at point." t nil)
...
Switch source file and its spec file." t nil)

(autoload 'crystal-spec-line "crystal-mode" "\
Run spec on current line." t nil)

(autoload 'crystal-spec-buffer "crystal-mode" "\
Run spec for current buffer." t nil)

(autoload 'crystal-spec-all "crystal-mode" "\
Run all specs for current project." t nil)
