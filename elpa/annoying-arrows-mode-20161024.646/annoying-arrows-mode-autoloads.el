...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "annoying-arrows-mode" '("annoying-arrows-" "add-annoying-arrows-advice" "aa-add-suggestion")))
