...

;;;### (autoloads nil "flymake-coffee" "flymake-coffee.el" (0 0 0
;;;;;;  0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "flymake-coffee" '("flymake-coffee-")))
