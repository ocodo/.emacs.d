...
the user has added to capture information)." t nil)
...
Raise an error if point isn't on an org-table." t nil)
...
return a new buffer with the new tree." t nil)
...
on what point is placed on." t nil)
