...
;; Rainbow delimiters
(defun rhuk-rainbow-delim-set-face ()
  (set-face-attribute 'rainbow-delimiters-depth-1-face nil :foreground "#b3490e")
  (set-face-attribute 'rainbow-delimiters-depth-2-face nil :foreground "#c55110")
  (set-face-attribute 'rainbow-delimiters-depth-3-face nil :foreground "#d75811")
  (set-face-attribute 'rainbow-delimiters-depth-4-face nil :foreground "#e95f12")
  (set-face-attribute 'rainbow-delimiters-depth-5-face nil :foreground "#ee6b21")
  (set-face-attribute 'rainbow-delimiters-depth-6-face nil :foreground "#ef7733")
  (set-face-attribute 'rainbow-delimiters-depth-7-face nil :foreground "#f08345")
  (set-face-attribute 'rainbow-delimiters-depth-8-face nil :foreground "#f28f57")
  (set-face-attribute 'rainbow-delimiters-depth-9-face nil :foreground "#f39b69")
  (set-face-attribute 'rainbow-delimiters-unmatched-face nil :foreground "#FF0000"))

(eval-after-load "rainbow-delimiters" '(rhuk-rainbow-delim-set-face))
