...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mime-bbdb" '("mime-bbdb/" "signature/")))
...
Unconditionally turn on MIME-Edit mode." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mime-edit" '("eliminate-top-spaces" "mime-" "replace-space-with-underline")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mime-w3" '("mime-" "url-cid")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "semi-setup" '("call-after-loaded" "mime-setup-")))
