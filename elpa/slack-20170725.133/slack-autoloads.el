...
;;;***

;;;### (autoloads nil "slack-message-changed" "slack-message-changed.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from slack-message-changed.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-message-changed" '("slack-message-changed" "_slack-")))

;;;***

;;;### (autoloads nil "slack-message-delete" "slack-message-delete.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from slack-message-delete.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-message-delete" '("slack-message-" "_slack-")))
...
;;;***

;;;### (autoloads nil "slack-message-update" "slack-message-update.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from slack-message-update.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-message-update" '("slack-message-update" "_slack-")))
...
;;;***

;;;### (autoloads nil "slack-room-history" "slack-room-history.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from slack-room-history.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-room-history" '("slack-" "_slack-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-slash-commands" '("slack-sla")))
