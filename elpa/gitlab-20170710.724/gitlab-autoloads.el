...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gitlab-mode" '("gitlab-" "create-" "print-current-line-id" "project-make-button")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gitlab-session" '("with-gitlab-auth")))
