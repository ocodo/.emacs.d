...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "eword-encode" '("ew-" "eword-" "make-ew-rword" "mime-header-" "tm-eword::")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hmac-sha1" '("hmac-sha1" "sha1-binary")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mel" '("7bit-" "8bit-" "Q-encod" "base64-encoded-length" "binary-" "encoded-text-encode-string" "mel-" "mime-encoding-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mel-q" '("q-encoding-" "quoted-printable-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mel-q-ccl" '("mel-ccl-" "q-encoding-ccl-" "quoted-printable-ccl-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mime-def" '("B-encoded-text-regexp" "Q-encoded-text-regexp" "base64-" "make-mime-content-" "mel-" "mime-" "quoted-printable-" "regexp-")))
...
Return value is a mime-content-type object.
If Content-Type field is not found, return nil." nil nil)
...
Return value is a mime-content-disposition object.
If Content-Disposition field is not found, return nil." nil nil)
...
Return value is a string.
If Content-Transfer-Encoding field is not found, return nil." nil nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mmgeneric" '("mime-" "mm-")))
