  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (font-lock-regexp-grouping-backslash (:foreground ,magenta))
      (font-lock-regexp-grouping-construct (:foreground ,violet))
      ...
      (linum (:background ,alt-background :foreground ,green))
