...
(defface 2048-face-2    '((t . (:background "khaki"))) "Face for the tile 2" :group '2048-faces)
(defface 2048-face-4    '((t . (:background "burlywood"))) "Face for the tile 4" :group '2048-faces)
(defface 2048-face-8    '((t . (:background "orange3"))) "Face for the tile 8" :group '2048-faces)
(defface 2048-face-16   '((t . (:background "orange"))) "Face for the tile 16" :group '2048-faces)
(defface 2048-face-32   '((t . (:background "orange red"))) "Face for the tile 32" :group '2048-faces)
...
(defface 2048-face-512  '((t . (:background "magenta"))) "Face for the tile 512" :group '2048-faces)
(defface 2048-face-1024 '((t . (:background "gold"))) "Face for the tile 1024" :group '2048-faces)
(defface 2048-face-2048 '((t . (:background "yellow"))) "Face for the tile 2048" :group '2048-faces)
