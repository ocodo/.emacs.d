...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kubernetes-utils" '("kubernetes-utils-")))
...
;;;***

;;;### (autoloads nil nil ("kubernetes-pkg.el" "kubernetes.el") (0
;;;;;;  0 0 0))
