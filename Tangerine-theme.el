(deftheme Tangerine
  "Tangerine By: Jasonm23 / Created 2012-06-29.")
  ...
  (custom-theme-set-faces
   ...
   `(linum
     ((t (:background "#311000" :foreground "#d13000" :box nil :height 100))))

   ;; Margin Fringes
   `(fringe
     ((t ( :background "#1f0a00" :Foreground "#603000" ))))

   ;; Mode-line / status line
   `(mode-line 
     ((t (:background "#1f0a00" :box nil :foreground "#ec5604" :height 85))))

   `(mode-line-inactive
     ((t (:weight light :box nil :background "#201000" :foreground "#603000" :inherit (mode-line)))))
   `(mode-line-emphasis 
     ((t (:weight bold))))
   ...
   ;; Cursor
   `(cursor
     ((t (:foreground "#ffffff" :background "#4c2400"))))

   ;; Minibuffer
   `(minibuffer-prompt 
     ((t (:weight bold :foreground "#cc6000"))))
   ...
   ;; Secondary region 
   `(secondary-selection
     ((((class color) (min-colors 88) (background dark)) (:background "#502400"))))
